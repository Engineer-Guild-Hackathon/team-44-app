    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-40 md:hidden">
          ...
          {/* Navigation Panel */}
          <nav
            className={`absolute top-0 left-0 h-full w-80 bg-[var(--color-bg-light)] border-r border-[var(--color-border)] shadow-xl z-50 transform transition-transform duration-300 ease-in-out md:relative md:top-auto md:left-auto md:h-screen md:shadow-lg md:transform-none md:transition-none md:overflow-hidden ${isOpen ? 'md:w-80 translate-x-0' : '-translate-x-full md:w-0'}`}
          >
            {/* Mobile Close Button */}
...
// ...existing code...
      ...
      {/* Desktop Navigation (md以上) */}
      <nav className={`hidden md:block fixed top-0 left-0 h-full w-80 bg-[var(--color-bg-light)] border-r border-[var(--color-border)] shadow-xl z-50 md:relative md:top-auto md:left-auto md:h-screen md:shadow-lg md:transform-none md:transition-none md:overflow-hidden ${isOpen ? 'md:w-80 translate-x-0' : '-translate-x-full md:w-0'}`}
        >
        {/* Desktop Header, Menu Items, etc. (同じ内容をここにも配置) */}
